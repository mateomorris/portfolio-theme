...
function create_each_block(ctx) {
	...
	let a_href_value;
	let current;
	icon = new Component({ props: { icon: /*icon*/ ctx[14] } });
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*links*/ 4) && t0_value !== (t0_value = /*link*/ ctx[13].label + "")) set_data(t0, t0_value);
			const icon_changes = {};
			if (dirty & /*links*/ 4) icon_changes.icon = /*icon*/ ctx[14];
			icon.$set(icon_changes);

			if (!current || dirty & /*links*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[13].url)) {
...
function create_fragment$1(ctx) {
	...
	let if_block = /*image*/ ctx[3].url && create_if_block$1(ctx);
	...
	return {
		...
		l(nodes) {
			...
			t2 = claim_text(span0_nodes, /*title*/ ctx[1]);
			...
			t6 = claim_text(h2_nodes, /*title*/ ctx[1]);
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*title*/ 2) set_data(t6, /*title*/ ctx[1]);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('variation' in $$props) $$invalidate(9, variation = $$props.variation);
		if ('vjsdn' in $$props) $$invalidate(10, vjsdn = $$props.vjsdn);
		if ('mthsj' in $$props) $$invalidate(11, mthsj = $$props.mthsj);
		if ('ljszd' in $$props) $$invalidate(12, ljszd = $$props.ljszd);
